                        ...
                        <div class="modal" id="myModal1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="/Admin/order/store/{{$fb->id}}/data/existing" method="post">
                                        {{ csrf_field() }}
                        ...
                        <div class="modal" id="myModal">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="/Admin/order/store/{{$fb->id}}/BAKBB/existing" method="post">
                                        {{ csrf_field() }}
                                        <div class="modal-body">
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/Admin/order/delete/{{$data->id}}/BAKBB/1/existing" type="button" class="btn btn-danger btn-sm">
                        ...
                        <div class="modal" id="myModal3">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="/Admin/order/store/2/{{$fb->id}}/BAKBB/existing" method="post">
                                        {{ csrf_field() }}
                                        <div class="modal-body">
                                            <div class="form-group row">
                                                <label class="col-md-5 col-form-label">Originating</label>
                            ...
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/Admin/order/delete/{{$item->id}}/BAKBB/2/existing" type="button" class="btn btn-danger btn-sm">
                                                <i class="fa fa-trash"></i> Delete
                                            </a>
                                        </td>
                                    </tr>
