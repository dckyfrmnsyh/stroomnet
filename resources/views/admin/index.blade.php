...
@push('after-script')
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            // Pie chart flotPie1
            var piedata = [
                { label: "Relokasi", data: [[1,{{$total_client_relokasi}}]], color: '#5c6bc0'},
                { label: "Upgrade", data: [[1,{{$total_client_upgrade}}]], color: '#03a9f3'},
                { label: "Downgrade", data: [[1,{{$total_client_downgrade}}]], color: '#ef5350'},
                { label: "New", data: [[1,{{$total_client_new}}]], color: '#66bb6a'}
            ];
