                        ...
                        <table class="table ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a href="/Admin/pdf/old/{{$downlist->id}}" target="_blank" class="btn btn-outline-success btn-sm"><i
                                                class="fa fa-download"></i> BAKBB
                                                </a>
                                        <a href="/Admin/pdf/fb/{{$downlist->id}}" target="_blank" class="btn btn-outline-primary btn-sm"><i
                                                class="fa fa-download"></i> FB</a>
                                    </td>
                                    <td>
                                        <a href="/Admin/dashboard/order/show_old/{{ $downlist->id }}" type="button"
