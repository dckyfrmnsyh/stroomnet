<?php 
    ...
    <div class="content">
        ...
        <div>
            <center>
                <h3 class="judul" style="font-size: 10pt;margin-left:20px">
        ...
        <table border="1" style="border-collapse: collapse; font-size: 7pt; width: 90%; margin-left:20px">
            <tr>
        ...
        <table style="margin-left:10px; width: 100%; font-size: 9pt">
            <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr style="text-align:center">
                ...
                <th style="text-align:center">PIHAK KEDUA</th>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            ...
            <tr>
                <th style="text-align:center">(Agus Widya Santoso)</th>
                <th style="text-align:center">&nbsp;</th>
                @foreach($customer as $c)
                <th style="text-align:center">( {{$c->penanggung_jawab}} )</th>
                @endforeach
            </tr>
        </table>
    </div>