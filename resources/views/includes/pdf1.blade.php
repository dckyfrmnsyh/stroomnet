...
?>
    ...
    box-shadow: 2px 3px 2px 3px #a3a3a34f;">
        ...
        <p style="font-size: 8pt; margin-left:20px;">
            Pada hari {{Date::parse($list_order->order_data->tanggal_kesepakatan)->format('l')}} ,tanggal
            {{Date::parse($list_order->order_data->tanggal_kesepakatan)->format('d')}} bulan {{Date::parse($list_order->order_data->tanggal_kesepakatan)->format('F')}} tahun
