    ...
    <div class="col-md-8">
        ...
        <div class="card  form-edit" id="form-edit">
            ...
            <div class="card-body">
                ...
                <form id="regForm" action="{{route('users.updatefb')}}" method="post">
                    {{ csrf_field() }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="provinsi" id="province" class="form-control">
                                        <option value="{{ old('provinsi') ? old('provinsi') : $provinsi->id }}">
                                ...
                                <div class="col-md-6">
                                    <select name="kota" id="regencies" class="form-control">
                                        <option value="{{ old('kota') ? old('kota') : $kota->id }}">{{$kota->name}}
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="kecamatan" id="districts" class="form-control">
                                        <option value="{{ old('kecamatan') ? old('kecamatan') : $kecamatan->id }}">
                                            {{$kecamatan->name}}</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <select name="desa" id="villages" class="form-control">
                                        <option value="{{ old('desa') ? old('desa') : $desa->id }}">{{$desa->name}}
                                        </option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <select name="id_card_pj" id="id_card_pj" class="form-control">
                                        <option value="{{ old('id_card_pj') ? old('id_card_pj') : $data->id_card_pj }}">
