                ...
                <div class="modal" id="myModal1">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="/users/profile/bakbb/update/data/{{$order_data->list_id}}" method="post">
                                {{ csrf_field() }}
                                    ...
                                    <div class="form-group row justify-content-center">
                                        ...
                                        <div class="col-md">
                                            <select name="tipe" id="tipe" class="form-control">
                                                <option value="{{ old('tipe') ? old('tipe') : $order_data->tipe }}">
                                                    {{$order_data->tipe}}</option>
                                                ...
                                                <option value="Layanan Upgrade On Demand">Layanan Upgrade On Demand
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                ...
                <div class="modal" id="myModal">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="/users/profile/bakbb/update/layanan/existing/{{$order_data->list_id}}" method="post">
                                {{ csrf_field() }}
                                <div class="modal-body">
                ...
                <div class="modal" id="myModal3">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <form action="/users/profile/bakbb/update/layanan/new/{{$order_data->list_id}}" method="post">
                                {{ csrf_field() }}
                                <div class="modal-body">
                                    <div class="form-group row">
                                        <label class="col-md-5 col-form-label">Originating</label>
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/users/profile/bakbb/delete/{{$item->id}}" type="button"
                                        class="btn btn-danger btn-sm">
                                        <i class="fa fa-trash"></i> Delete
                                    </a>
                                </td>
