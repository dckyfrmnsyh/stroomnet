...
<div class="row justify-content-center">
    ...
    <div class="col-md-8" style="margin-bottom:20px">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <!-- Button to Open the Modal -->
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalBaru">
                    <i class="fa fa-plus"></i> Tambah Order
                </button>
                <!-- The Modal -->
                <div class="modal" id="myModalBaru">
                    <div class="modal-dialog">
                        <div class="modal-content">
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="/users/profile/bakbb/delete/{{$data->id}}" type="button" class="btn btn-danger btn-sm">
